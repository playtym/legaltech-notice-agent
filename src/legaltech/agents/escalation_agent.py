...
_INDUSTRY_SIGNALS: dict[str, tuple[str, ...]] = {
    "banking_finance": ("bank", "loan", "emi", "credit card", "debit card", "wallet",
                        "nbfc", "fintech", "mutual fund", "investment",
                        "neft", "rtgs", "imps", "aadhaar pay", "razorpay", "paytm", "phonepe"),
    "upi_payment": ("upi", "upi failed", "payment failed", "money deducted", "double debit",
                    "auto reversal", "t+5", "failed transaction", "gpay", "bhim",
                    "amount deducted but not credited", "payment gateway",
    ...
    "dark_pattern": ("dark pattern", "false urgency", "basket sneaking", "confirm shaming",
                     ...
                     "bait and switch", "hidden cost", "nagging", "disguised ad",
                     "pre-ticked", "auto renew", "forced continuity", "drip pricing"),
    ...
    "education": ("university", "college", "coaching", "edtech", "course", "admission",
                  ...
                  "placement guarantee", "course refund", "learning app"),
...
_SECTOR_REGULATORS: dict[str, list[tuple[str, str, str]]] = {
    ...
    "upi_payment": [
        ("RBI Ombudsman", "File complaint on cms.rbi.org.in — covers UPI, wallets, IMPS, NEFT under Integrated Ombudsman Scheme 2021",
         "RBI Integrated Ombudsman Scheme 2021; Payment and Settlement Systems Act 2007 §18"),
        ("NPCI Dispute Resolution", "Escalate via bank's UPI complaint mechanism — bank must resolve within T+5 or auto-escalate to NPCI",
         "RBI Circular on Harmonisation of TAT for Failed Transactions (RBI/DPSS/2019-20/174)"),
        ("Reserve Bank of India — DPSS", "Report non-compliance with auto-reversal timeline directly to RBI Department of Payment and Settlement Systems",
         "Payment and Settlement Systems Act 2007; RBI Master Direction on Digital Payment Security Controls"),
    ],
    "dark_pattern": [
        ("Central Consumer Protection Authority (CCPA)",
         "File complaint for use of dark patterns constituting unfair trade practice — CCPA empowered to investigate, impose penalty up to ₹50 lakh",
         "CPA 2019 §§18-27; CCPA Guidelines for Prevention and Regulation of Dark Patterns, 2023"),
        ("Department of Consumer Affairs",
         "Escalate via INGRAM portal (ingram.gov.in) or NCH (1800-11-4000); dark patterns enabled via Government notification",
         "Consumer Protection Act, 2019; Dark Patterns Guidelines 2023"),
        ("MeitY / IT Act Authority",
         "If dark patterns involve processing personal data without valid consent, report under DPDP Act 2023 to Data Protection Board",
         "DPDP Act 2023 §7 (consent via dark patterns is invalid); IT Act 2000 §43A"),
    ],
    "ecommerce": [
        ("Central Consumer Protection Authority (CCPA)",
    ...
    "airline_travel": [
        ...
        ("Ministry of Civil Aviation",
         "Escalate to MoCA via CPGRAMS if airline does not comply with DGCA CAR",
         "DGCA Passenger Charter of Rights; Carriage by Air Act 1972"),
    ],
    "real_estate": [
        ("RERA Authority (state-specific)",
         "File complaint on state RERA portal for delayed possession / builder default — adjudication within 60 days",
         "Real Estate (Regulation and Development) Act, 2016 §31"),
        ("RERA Appellate Tribunal",
         "Appeal RERA order within 60 days to RERA Appellate Tribunal; can seek stay of builder's operations",
         "RERA 2016 §§43-44"),
    ],
    "insurance": [
        ("IRDAI — Integrated Grievance Management System (IGMS)",
         "File complaint on igms.irda.gov.in — IRDAI mandates insurer response within 15 days",
         "IRDAI (Protection of Policyholders' Interest) Regulations 2017"),
        ("Insurance Ombudsman",
         "Escalate to Insurance Ombudsman (per address list on irdai.gov.in) — free, binding up to ₹30 lakh for life/₹20 lakh for others",
         "Insurance Ombudsman Rules, 2017; CPA 2019"),
    ],
    "food_fmcg": [
        ...
        ("Local Food Safety Officer (FSO)",
         "File complaint with district FSO for inspection and seizure of expired/contaminated products",
         "FSSA 2006 §38 (powers of Food Safety Officer)"),
    ],
    "automobile": [
    ...
    "education": [
        ...
        ("CCPA — Ed-Tech Enforcement",
         "File complaint for misleading placement guarantees or aggressive sales practices by ed-tech companies",
         "CPA 2019 §§18-27; CCPA orders against ed-tech companies (2022-2024)"),
    ],
    "healthcare": [
    ...
    "credit_score": [
        ("RBI — Credit Information Companies supervision",
         "Report incorrect credit reporting to RBI via cms.rbi.org.in — RBI supervises all CICs",
         "Credit Information Companies (Regulation) Act, 2005 §15; RBI Master Direction on CICs"),
        ("CIBIL / Experian / Equifax / CRIF dispute portal",
         "File formal dispute with the CIC directly via their online portal — CIC must resolve within 30 days",
         "CICRA 2005 §15; RBI circular RBI/2021-22/25 on accuracy of credit data"),
    ],
}
